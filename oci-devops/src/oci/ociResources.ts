...
export const RESOURCES = {
    ...
    'docker_nodejs_build_spec.yaml': require('../../resources/oci/docker_nodejs_build_spec.yaml.handlebars'),
    ...
    'Dockerfile.nodejs': require('../../resources/oci/Dockerfile.nodejs.handlebars'),
    ...
    'nodejs_build_spec.yaml': require('../../resources/oci/nodejs_build_spec.yaml.handlebars'),
